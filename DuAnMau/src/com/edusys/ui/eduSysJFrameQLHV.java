 ...
 * @author dangd
 */
public class eduSysJFrameQLHV extends javax.swing.JDialog {

    /**
     * Creates new form eduSysJFrameQLHV
     */
    public eduSysJFrameQLHV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eduSysJFrameQLHV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                eduSysJFrameQLHV dialog = new eduSysJFrameQLHV(new javax.swing.JFrame(), true);
