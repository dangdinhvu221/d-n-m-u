 ...
 * @author dangd
 */
public class eduSysJFrameQLNH extends javax.swing.JDialog {

    /**
     * Creates new form eduSysJFrameQLNH
     */
    public eduSysJFrameQLNH(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eduSysJFrameQLNH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                eduSysJFrameQLNH dialog = new eduSysJFrameQLNH(new javax.swing.JFrame(), true);
